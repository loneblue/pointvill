...
var yxDays=new Array("일", "월", "화", "수", "목", "금", "토", "일");
var yxLinks=new Array("[닫기]", "");
...
addCalendar("Calendar1", "Select Date", "Date1", "frm_main");
addCalendar("Calendar2", "Select Date", "Date2", "frm_main");
